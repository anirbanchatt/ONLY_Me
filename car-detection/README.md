...
The file yolo.h5 is needed which is quite large so it is needed to be downloaded online. Please download [yolo.h5](https://www.kaggle.com/datasets/rmoharir8396/yolo-h5-file/code) and add it to the folder image_data.
